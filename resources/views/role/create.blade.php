...
<div class="container-fluid border shadow bg-white rounded p-3">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <h1>{{ ('Создание роли') }}</h1>
            <form id="role_add_form" method="POST" action="{{ route('create-role') }}">
                @csrf
                <div class="col-4 mb-3">
                    ...
                    <div class="form-text">Название роли (должности) на русском языке.<br> Пример: Директор.</div>
                </div>
                <div class="col-4 mb-3">
                ...
                <div class="container my-4 py-2">
                    <div class="row">
                        @foreach($permissionСategories as $permissionName => $permission)
                            <div class="col-lg-4 border-right border-left pl-4">
